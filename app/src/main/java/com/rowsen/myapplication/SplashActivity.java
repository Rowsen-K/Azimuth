...
import static com.rowsen.myapplication.Myapp.GDT_APPID;
...
public class SplashActivity extends BaseActivity {
    ...
    //Mi开屏广告ID
    private static final String POSITION_ID = "5c8ad4178822044b073c5bfa78cb42dd";
    //Mi测试参数
        ...
        try {
            mWorker = AdWorkerFactory.getAdWorker(SplashActivity.this, mi_container, new MimoAdListener() {
                ...
                public void onAdLoaded(int size) {
                    ...
                    mi_container.setVisibility(View.VISIBLE);
                }
...
/*            }
    ...
    private void fetchSplashAD() {
        ...
        splashAD = new SplashAD(this, GDT_container, null, GDT_APPID, GTD_SplashID, new SplashADListener() {
            ...
            public void onADPresent() {
                ...
                mi_container.setVisibility(GONE);
    ...
    void logo_show() {
        logo_pic.setVisibility(View.GONE);
        mi_container.setVisibility(GONE);
        GDT_container.setVisibility(View.GONE);
